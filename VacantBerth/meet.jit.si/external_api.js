! function(e, t) {
    ...
    return function(e) {
        ...
        const I = ["css/all.css", "libs/alwaysontop.min.js"],
            k = {
        ...
        class M extends i.a {
            ...
            _getAlwaysOnTopResources() {
                ...
                return I.map(e => new URL(e, n).href)
            }
                ...
                this._transport.on("event", e => {
                    ...
                    switch (t) {
                        case "video-conference-joined":
                            void 0 !== this._tmpE2EEKey && (this.executeCommand(k.e2eeKey, this._tmpE2EEKey), this._tmpE2EEKey = void 0), this._myUserID = r, this._participants[r] = {
                        ...
                        case "display-name-change":
                            {
                                const e = this._participants[r];e && (e.displayName = n.displayname, e.formattedDisplayName = n.formattedDisplayName);
                                break
                            }
                        case "email-change":
                            {
                                const e = this._participants[r];e && (e.email = n.email);
                                break
                            }
                        case "avatar-changed":
                            {
                                const e = this._participants[r];e && (e.avatarURL = n.avatarURL);
                                break
                            }
            ...
            executeCommand(e, ...t) {
                e in k ? this._transport.sendEvent({
                    data: t,
                    name: k[e]
