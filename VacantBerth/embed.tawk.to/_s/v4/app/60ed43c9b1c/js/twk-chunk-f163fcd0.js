                ...
                n = Object(i.a)(s, (function() {
                    ...
                    return a("div", {
                        ...
                        return a("div", {
                            ...
                            ref: t.blockId,
                            refInFor: !0,
                            staticClass: "tawk-margin-small-bottom tawk-flex tawk-flex-bottom tawk-message-block",
                            attrs: {
                                id: "blockId-" + t.blockId
                            }
                        }, ["call" === t.messageType ? [t.callData && !t.callData.hasError ? a("tawk-alert", {
                            staticStyle: {
                                width: "100%"
                            },
                            attrs: {
                                ...
                                description: e.callDescription(t.callData),
                            ...
                            attrs: {
                                ...
                                description: e.$i18n("chat", "call_error_load"),
                                icon: "call"
                            }
                        })] : ["c" === t.messageType && "v" !== t.senderType ? a("tawk-avatar", {
                            staticClass: "tawk-message-profile tawk-flex-none",
                            attrs: {
                                size: "small",
                                src: t.profileImage,
                                alt: "" + e.$i18n("chat", "agent_profile_image")
                            }
                        }) : e._e(), a("div", {
                            staticClass: "tawk-message-group tawk-flex-1",
                            class: ["v" == t.senderType ? "tawk-margin-auto-left" : ""]
                            ...
                            return a("div", {
                            ...
                            }, [t.showBar && e.barMessageRerence ? a("div", {
                                staticStyle: {
                                    position: "relative"
                                }
                            }, [a("div", [a("span", {
                            ...
                            }, [e._v(e._s(e.$i18n("chat", "newMessages")))]), a("hr")])]) : e._e(), "c" === t.type ? [a("div", {
                                staticClass: "tawk-flex tawk-flex-bottom",
                                class: ["v" == t.senderType ? "tawk-visitor-chat" : "tawk-agent-chat"],
                                on: {
                                    mouseenter: e.onMouseEnter
                                }
                            }, ["v" === t.senderType ? a("div", {
                                staticClass: "tawk-flex-none",
                                staticStyle: {
                                    "min-width": "40px"
                                }
                            }, [t.time ? a("tawk-timeago", {
                                ...
                                class: ["v" !== t.senderType ? "tawk-margin-xsmall-right" : ""]
                            }, [t.isUpload ? a("tawk-card", {
                                class: ["v" == t.senderType ? "tawk-visitor-chat-bubble" : "tawk-agent-chat-bubble"],
                                attrs: {
                                    color: "inverse",
                                    size: "small"
                                }
                            }, [t.fileType ? ["image" === t.fileType ? a("tawk-image", {
                                attrs: {
                                    src: t.fileLink,
                                    name: t.fileName,
                                    position: "center"
                            ...
                            }) : e._e(), "video" === t.fileType ? a("tawk-video", {
                                attrs: {
                                    content: {
                                        source: "selfhosted",
                                        url: t.fileLink,
                            ...
                            }, [e._v(" " + e._s(t.fileName) + " ")]), a("span", {
                                staticClass: "tawk-flex-none",
                                staticStyle: {
                                    padding: "0 5px"
                                }
                            }, [e._v(" " + e._s(t.humanizeFileSize) + " ")])]), a("a", {
                                staticStyle: {
                                    color: "inherit",
                            ...
                            }, [e._v(" " + e._s(e.$i18n("chat", "download")) + " "), a("tawk-icon", {
                                attrs: {
                                    type: "download",
                                    size: "small"
                                }
                            })], 1)] : e._e()], 2) : a("div", [t.isPending ? a("tawk-spinner", {
                                class: ["v" !== t.senderType ? "lds-spinner-left" : ""]
                            }) : e._e(), a("tawk-card", {
                                class: ["v" == t.senderType ? "tawk-visitor-chat-bubble" : "tawk-agent-chat-bubble", "tawk-text-regular-3"],
                                attrs: {
                                    color: "primary",
                                    size: "small"
                                }
                            }, [t.surveyObj ? a("div", [a("p", {
                                domProps: {
                                    innerHTML: e._s(t.surveyObj.question)
                                }
                            }), e._l(t.surveyObj.options, (function(s, i) {
                                return a("label", {
                                    key: i,
                                    staticClass: "tawk-flex tawk-flex-middle tawk-margin-xsmall"
                                }, [a("input", {
                                    staticStyle: {
                                        margin: "0px"
                                    },
                            ...
                            }) : e._e()], 1) : e._e()]), t.sendFailed ? a("div", {
                            ...
                            }), a("span", [e._v("Failed")])], 1), a("tawk-button", {
                                attrs: {
                                    isText: !0
                                },
                                on: {
                                    click: function(a) {
                                        return e.resendMessage(t)
                                    }
                                }
                            }, [e._v(" Resend ")])], 1) : e._e()] : e._e(), "v" === t.senderType && "n" === t.type ? a("div", [a("tawk-card", {
                                attrs: {
                                    color: "inverse",
                                    size: "xsmall"
                                }
                        ...
                        methods: {
                            displayMessages: function(t) {
                                ...
                                if (!n.profileImage && n.data && n.data.rsc) {
                                    var p = this.agentProfile(n.data.rsc);
                                    if (!p) return;
                                    n.profileImage = p.profileImage
                                }
                                if (m.length > 0 && "c" === n.type && ((a = m[m.length - 1]).ownerId === n.ownerId ? (n.blockId = a.blockId, a.messages.push(n)) : a = null), n.timeStamp > this.lastMessageTimestamp && ("v" === n.senderType ? this.$store.dispatch("session/updateVisitorChatSeen", n.timeStamp) : (this.unseenMessages.push(n), d && !this.isLoading || this.barMessageId || (n.showBar = !0, this.barMessageId = n.messageId, this.barMessageRerence = n))), r && "a" === n.senderType && n.data && n.data.rsc && this.removeAgentIsTyping(n.data.rsc), n.isCallView) {
                                    ...
                                    c ? this.$store.dispatch("chat/addMessageBlock", g) : this.$store.dispatch("history/addMessageBlock", g)
                                } else if (!a) {
                                    ...
                                    n.blockId = u.blockId, c ? this.$store.dispatch("chat/addMessageBlock", u) : this.$store.dispatch("history/addMessageBlock", u)
                                }
                                r && ("v" === n.senderType || d ? this.scrollToBottom() : this.checkBarPosition())
                            },
                    ...
                    methods: {
                        ...
                        callDescription: function(e) {
                            var t = new Date(e.startedAt),
                                ...
                                s = t.getMinutes();
                            if (e.isDone) {
                                if (a < 10 && (a = "0" + a), s < 10 && (s = "0" + s), e.isRejected || e.isMissed) return this.$i18n("chat", "call_started_on", {
                                    startedOn: "".concat(a, ":").concat(s)
                                });
                                var i, n, l, r = 6e4,
                                    o = 60 * r,
                                    c = new Date(e.endedAt).getTime() - new Date(e.startedAt).getTime();
                                return c >= o ? (i = Math.round(c / o), l = "hours") : c >= r ? (i = Math.round(c / r), l = "minutes") : (i = Math.round(c / 1e3), l = "seconds"), n = this.$i18n("chat", l, {
                                    num: i
                        ...
                        callIcon: function(e) {
                            return e.isVideo ? "video-chat" : e.isScreenshare ? "screenshare" : "call"
                        },
