        ...
        "27c6": function(e, t, i) {
            ...
            var a = function() {
                function e(t) {
                    (function(e, t) {
                        if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
                    })(this, e), this.store = t, this.setupTimeout = null, this.agentCountSubscription = null, this.originalPageStatus = null, this.utcOffset = 0
                }
                return function(e, t, i) {
                    t && n(e.prototype, t), i && n(e, i)
                }(e, [{
                    key: "setup",
                    value: function() {
                        this.clear(), null === this.originalPageStatus && (this.originalPageStatus = this.store.getters["session/pageStatus"]), this.store.getters["schedule/isEnabled"] ? (this.utcOffset = -1 * ((new Date).getTime() - this.store.getters["schedule/timezone"].utc), this.calculate()) : this.store.dispatch("session/updatePageStatus", this.originalPageStatus)
                    }
                }, {
                    key: "clear",
                    value: function() {
                    ...
                    key: "cleanUp",
                    value: function() {
                        this.clear(), this.originalPageStatus = null, "function" == typeof this.unwatchAgentCount && this.unwatchAgentCount()
                    }
                }, {
                    key: "calculate",
                    value: function() {
                        var e = this;
                        if (this.clear(), this.store.getters["schedule/isEnabled"]) {
                    ...
                    key: "goOnline",
                    value: function() {
                        "offline" !== this.originalPageStatus && this.store.dispatch("session/updatePageStatus", this.originalPageStatus)
                    }
                }, {
                    key: "goOffline",
                    value: function() {
                        var e = this;
                        0 === this.store.getters["chat/agentsCount"] && this.store.dispatch("session/updatePageStatus", "offline"), this.unwatchAgentCount = this.store.watch((function(e) {
                    ...
                    t.default = {
                        ...
                        actions: {
                            ...
                            setPageStatus: function(t, i) {
                                var n, a = t.state;
                                i && ((n = i.ast) && o.a.isString(n) && (!i.dptst || Array.isArray(i.dptst)) && i.asver > a.pageStatusVersion && (e.Tawk_Window.scheduler.originalPageStatus = i.ast, 0 !== a.pageStatusVersion && e.Tawk_Window.scheduler.calculate(), a.pageStatusVersion = i.asver, a.departments = i.dptst, a.pageStatus = i.ast, e.Tawk_Window.jsApi.triggerApiHandlers("onStatusChange", i.ast)))
                            },
                            ...
                            resetState: function(e) {
                                for (var t = e.commit, i = e.state, n = {
                                        chatBubbleClosed: !1,
                                        chatWindowState: "min",
                                        criticalVersion: 0,
                                        departments: [],
                                        ...
                                        waitTimeInitialized: !1,
                                        isReconnecting: !1
                                    }, a = Object.keys(n), o = 0; o < a.length; o++) {
                                    var s = a[o];
                                    i[s] = n[s]
                                }
                                clearTimeout(i.waitTimeTimeout), t("setWaitTimeFirstTime", !1), t("setWaitTimeInitialized", !1)
                            },
                ...
                return function(e, t, i) {
                    ...
                    value: function(e, t) {
                        ...
                        n.a.get("".concat("https://va.tawk.to", "/v1/widget-settings"), {
                            ...
                            }, i.languageScript.async = !0, i.languageScript.charset = "UTF-8", i.languageScript.src = "".concat("https://embed.tawk.to/_s/v4/app/60ed43c9b1c", "/languages/").concat(a.data.widget.language, ".js")
                        }))
                    }
                }, {
                    key: "processSettings",
        ...
        "56d7": function(e, t, i) {
            ...
            i.r(t),
                function(e) {
                    ...
                    function b() {
                        if (w.a.dispatch("reset"), w.a.dispatch("property/updateId", window.$_Tawk_AccountKey), w.a.dispatch("widget/updateId", window.$_Tawk_WidgetId), e.Tawk_Window.jsApi.local_API.isPopup) {
                            var t = function(e) {
                                var t, i, n, a, o = {};
                        ...
                        try {
                            Object(k.a)(i).then((function(t) {
                                "fulfilled" === t[0].status && "fulfilled" === t[1].status && (t[0].value.settingsVersion === t[1].value ? (S(t[0].value), T()) : (e.Tawk_Window.widgetSettings.version = t[0].value.settingsVersion, e.Tawk_Window.widgetSettings.getSettings((function() {
                                    S(t[0].value), T()
                                }), (function(e) {
                                    console.error(e)
                                }))))
                    ...
                    t.a.config.productionTip = !1, e.Tawk_Window = {
                            ...
                            delete window.$_Tawk.downloaded, w.a.dispatch("router/clearHistory"), b()
                        },
                        function() {
                            if (void 0 === window.$_Tawk.downloaded) {
                                ...
                                new r.a(w.a), e.Tawk_Window.logger = new n.a, e.Tawk_Window.register = new c.a(w.a), e.Tawk_Window.webStorage = new o.a(w.a), e.Tawk_Window.widgetSettings = new s.a(w.a), e.Tawk_Window.jsApi = new u.a(w.a), e.Tawk_Window.audioPlayer = new d.a(w.a), e.Tawk_Window.scheduler = new l.a(w.a), e.Tawk_Window.chatManager = new h.a(w.a), e.Tawk_Window.activityMonitor = new f.a(w.a), e.$_Tawk.startTime = (new Date).getTime().toString(), e.$_Tawk.loaded = !1, e.$_Tawk.connected = !1, e.$_Tawk.ready = !1, e.Tawk_Window.eventBus = v.a, t.a.use(a.a, {
                                        store: w.a
                                    }), t.a.use(y.a),
                                    function() {
            ...
            var n = "&quot;",
                ...
                v = {
                    ...
                    markdownToHtml: function(e) {
                        return e = this.rawEncode(e), e = (e = (e = this.toLinkable(e)).replace(/_(.*?)_/gim, "<i>$1</i>")).replace(/\*\*(.*?)\*\*/gim, "<b>$1</b>").replace(/\*(.*?)\*/gim, "<b>$1</b>")
                    },
                ...
                n.a.directive("tawk-scroll", o.TawkScroll), t.a = {
                    ...
                    computed: d(d({}, Object(a.c)({
                        ...
                        styleObject: function() {
                            ...
                            return this.isEmbedded ? n["position:"] = "relative !important;" : this.isPopup ? n["position:"] = "fixed !important;" : (n["position:"] = "fixed !important;", this.isBottom || this.isCenter ? (t = "".concat("0px", " !important;"), i = "auto !important;") : (t = "auto !important;", i = "".concat("0px", " !important;")), this.isVisible ? n["display:"] = "block !important;" : n["display:"] = "none !important;", n["left:"] = this.isRight ? "auto !important;" : "".concat("0px", " !important;"), n["right:"] = this.isRight ? "".concat("0px", " !important;") : "auto !important;", n["bottom:"] = t, n["top:"] = i, n["transform:"] = "none !important;"), e = d(d({}, this.genericStyles), n), Object.entries(e).map((function(e) {
                                var t = r(e, 2);
                                return t[0] + t[1]
                            })).join("\n")
                        }
