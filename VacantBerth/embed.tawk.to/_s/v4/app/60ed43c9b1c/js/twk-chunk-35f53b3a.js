        ...
        "3d78": function(t, e, a) {
            ...
            var l = {
                ...
                h = Object(u.a)(l, (function() {
                    ...
                    })], 1) : "chat" === t.card.type ? [t.showStartChatButton && t.hasLiveChat ? a("tawk-card", {
                        staticClass: "tawk-box-shadow-xsmall",
                        class: "card--" + t.card.type,
                        attrs: {
                            id: t.card.id,
            ...
            var s = a("e906").a,
                ...
                r = Object(i.a)(s, (function() {
                    ...
                    return a("div", {
                        ...
                        staticClass: "tawk-route-back tawk-flex tawk-flex-middle tawk-flex-1"
                    }, [a("tawk-button", {
                        directives: [{
                            name: "tawk-tooltip",
                    ...
                    }, [t._v(" " + t._s(t.currentView.title()) + " ")]) : t._e()], 1) : t._e(), a("div", {
        ...
        "6bf7": function(t, e, a) {
            ...
            (function(t) {
                ...
                e.a = {
                    ...
                    data: function() {
                        return {
                            cssLink: "".concat("https://embed.tawk.to/_s/v4/app/60ed43c9b1c", "/css/max-widget.css"),
                            classString: "",
                            showEndChat: !1,
                            noZoomMetaTag: null,
                            resizeHeightTo: null,
                    ...
                    computed: m(m({}, Object(s.c)({
                        ...
                        showBackButton: function() {
                            return this.currentView && ("chat" === this.currentView.path || "prechat" === this.currentView.path) && this.hasHomeView && !this.isOverlayOpen
                        },
                        ...
                        isHomeViewVisible: function() {
                            return this.needConsent || "chat" !== this.currentRoute && "prechat" !== this.currentRoute && this.hasHomeView && (!this.hasPrechatHistory || this.prechatFormSubmitted)
                        }
                    }),
                    watch: {
                    ...
                    methods: m(m({}, Object(s.b)({
                        ...
                        loaded: function() {
                            ...
                            if (this.hasHomeView || (this.updateRoute({
                                    ...
                                    e.$store.commit("router/changeCurrentView", null), t.Tawk_Window.activityMonitor.setupMaxWidgetListeners()
                    ...
                    mounted: function() {
                        this.noZoomMetaTag = document.createElement("meta"), this.noZoomMetaTag.name = "viewport", this.checkRouteLoaded()
                    }
                }
            }).call(this, a("c8ba"))
        },
            ...
            (function(t) {
                ...
                e.a = {
                    ...
                    beforeDestroy: function() {
                        ...
                        this.$store.commit("chat/setLastScrollPosition", this.isScrollBarBottom() ? 9999999999 : t.scrollTop), this.clearData()
                    },
                    methods: m(m({}, Object(s.b)({
                        ...
                        handleScrollProcess: function() {
                            this.checkBarPosition(), this.checkSeenMessageViewport()
                        },
                        scrollToEl: function(t) {
                            if (t) {
                                ...
                                a && a.length && s && ("undefined" !== a[0].offsetTop ? s.scrollTop = a[0].offsetTop - 40 : s.scrollTop = a[0].offsetTop, this.$refs["tawk-chat-panel"] && this.$refs["tawk-chat-panel"].$scrollbar && this.$refs["tawk-chat-panel"].$scrollbar.update())
                            }
                        },
                        ...
                        checkSeenMessageViewport: function() {
                            ...
                            if (0 !== this.unseenMessages.length && a) {
                                ...
                                } - 1 !== e && ((t = this.unseenMessages[this.unseenMessages.length - 1]) && this.$store.dispatch("session/updateVisitorChatSeen", t.timeStamp))
                            }
                        },
                        ...
                        removeAgentIsTyping: function(t) {
                            if (this.agentTyping.length)
                                for (var e = 0; e < this.agentTyping.length; e++)
                                    if (this.agentTyping[e].rsc === t) {
                                        this.agentTyping.splice(e, 1);
                                        break
                                    }
                        },
                ...
                r = Object(i.a)(s, (function() {
                    ...
                    return a("i-frame", {
                        ...
                        directives: [{
                            name: "show",
                            rawName: "v-show",
                            value: "chat" === t.currentRoute,
                            expression: "currentRoute === 'chat'"
                        }],
                        ref: "chat-view"
                    })], 1), a("transition", {
                        attrs: {
                    ...
                    }, [!t.hasLiveChat || t.needConsent || !t.isPrechatEnabled || t.prechatFormSubmitted || "prechat" !== t.currentRoute && t.hasHomeView && (!t.hasPrechatHistory || t.prechatFormSubmitted) ? t._e() : a("prechat-view", {
                        ref: "prechat-view"
                    })], 1), a("transition", {
                        attrs: {
                            name: "slide-fade",
                ...
                e.a = {
                    ...
                    computed: n(n({}, Object(s.c)({
                        ...
                        wrapperClasses: function() {
                            return this.hasBackground ? ["tawk-toolbar", "tawk-card-primary", "tawk-flex", "tawk-card-small", "tawk-text-right", "tawk-flex-none", "tawk-flex-middle", "tawk-custom-color"] : ["tawk-toolbar"]
                        },
                        ...
                        isHamburgerMenuVisible: function() {
                            return "offline" !== this.pageStatus && "chat" === this.currentRoute
                        }
                    }),
                    methods: n(n({}, Object(s.b)({
                        routerPush: "router/routerPush",
            ...
            (function(t) {
                ...
                e.a = {
                    ...
                    methods: o(o({}, Object(s.b)({
                        ...
                        dragover: function(t) {
                            t.preventDefault(), this.isDraggedOver = !0
                        },
                        dragleave: function(t) {
                            t.preventDefault(), t.currentTarget.contains(t.relatedTarget) || (this.isDraggedOver = !1)
                        },
                        drop: function(t) {
                            this.hasLiveChat && (t.preventDefault(), this.isDraggedOver = !1, this.$refs["tawk-chatinput"] && this.$refs["tawk-chatinput"].$refs && this.$refs["tawk-chatinput"].$refs.fileupload && (this.$refs["tawk-chatinput"].$refs.fileupload.files = t.dataTransfer.files, this.$refs["tawk-chatinput"].onFileUpload()))
                        },
                        ...
                        paste: function(t) {
                            ...
                            a && ((e = a.files) && e.length && (this.$refs["tawk-chatinput"].$refs.fileupload.files = e, this.$refs["tawk-chatinput"].onFileUpload()))
                        }
                    })
                }
            }).call(this, a("c8ba"))
